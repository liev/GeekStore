        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmountCRC = table.Column<decimal>(type: "numeric", nullable: false),
                    ...
                    DeliveryPointId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    PriceCRC = table.Column<decimal>(type: "numeric", nullable: false),
                    ...
                    PreferredDeliveryPointId = table.Column<int>(type: "integer", nullable: true),
                    CartAdditionCount = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_DeliveryPoints_PreferredDeliveryPointId",
                        column: x => x.PreferredDeliveryPointId,
                        principalTable: "DeliveryPoints",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AdminResolution = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Disputes_Users_TargetUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitPriceCRC = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_PreferredDeliveryPointId",
                table: "Products",
                column: "PreferredDeliveryPointId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ReviewerId_SellerId",
                table: "Reviews",
                columns: new[] { "ReviewerId", "SellerId" },
                unique: true);
