# GeekStore 
GeekStore — Marketplace P2P para Coleccionistas

GeekStore es una plataforma de comercio electrónico orientada a la compra, venta e intercambio de artículos de nicho como TCG (Magic, Pokémon), Figuras, Videojuegos y Cómics. El sistema permite a los usuarios registrarse como compradores o vendedores, gestionar inventarios complejos con integración de Moxfield para la importación de mazos, y realizar transacciones seguras.
